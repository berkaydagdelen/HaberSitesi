<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="AdminBilgileri.aspx.cs" Inherits="AdminBilgileri" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Admin Bilgileri </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
