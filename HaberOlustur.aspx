<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="HaberOlustur.aspx.cs" Inherits="HaberOlustur" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Haber Oluştur </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
