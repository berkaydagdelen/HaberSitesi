                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body p-0">
                                    <div class="mailbox-controls">
                                        ...
                                        <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-sm" Text="Yenile" OnClick="Button1_Click1" />


                                        <!-- /.btn-group -->

                                        <div class="float-right">
                                            <cc1:CollectionPager ID="CollectionPager1" runat="server" PageSize="20" SliderSize="10" ControlCssClass="Sayfalama" ResultsLocation="None" QueryStringKey="Sayfa" BackText="« Geri" LabelText="" NextText="İleri»"></cc1:CollectionPager>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="mailbox-subject"><b><%#Eval("iletisimMail") %></b> - <%#Eval("iletisimbaslik") %>
                                                            </td>
