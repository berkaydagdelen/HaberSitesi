...
public partial class Adminiletisim : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand komut = new SqlCommand("SELECT iletisimid, iletisimAdSoyad, iletisimMail, iletisimbaslik, iletisimMesaj, iletisimTarih  FROM    Tbl_iletisim order by  iletisimid desc ", baglanti);
